...
<head>
  ...
  <style>
    ...
    .power-btn {
      ...
      background: url('file:///C:/Users/Kavee/Downloads/maklay62-button-1428090_1920.png') no-repeat center/contain;
    ...
    .power-btn:hover {
      transform: scale(1.1);
      filter: drop-shadow(0 0 35px var(--danger-red));
    }
    ...
    .piston-block {
      ...
      background: rgba(20, 0, 0, 0.8); border-radius: 8px;
...
<body>
  ...
  <div id="start-screen">
    <button class="power-btn" onclick="initializeEngine()"></button>
  </div>
  ...
  <script>
    const bgVideos = [
      'file:///C:/Users/Kavee/Downloads/dark-batman-shadow-portrait-live-wallpaper.mp4',
      'file:///C:/Users/Kavee/Downloads/hot-summer-live-wallpaper.mp4',
      'file:///C:/Users/Kavee/Downloads/black-toyota-supra-live-wallpaper.mp4'
    ];
