...
custom_sound = st.sidebar.toggle("🔊 Play Custom Sound (hihi.mp3)", value=False)

# High Quality Batman Wallpaper Direct Link
BATMAN_BG_URL = "https://images.wallpapersden.com/image/download/batman-dark-knight_bWlqZm6UmZqaraWkpJRmZ21lrWxnZQ.jpg"
...
# ---------------------------------------------------------
# 3. DICTIONARY & BILINGUAL / BAT-MODE DIALOGUES
# ---------------------------------------------------------
BAT_QUOTES = [
...
SYLLABUS = {
    ...
    • **Viscosity (Stokes' Law):** Drag Force F = 6ηrv
    """,
...
# ---------------------------------------------------------
# 4. ADVANCED SYMPY & TEXT SOLVER ENGINE
# ---------------------------------------------------------
    ...
    if st.button(LANG_DATA[language]["solve_btn"]):
        if user_query.strip():
            with st.spinner("Bat-Computer Analyzing Equations..."):
                ...
                if custom_sound:
                    play_local_sound("hihi.mp3")
                elif bat_mode:
                    play_url_sound("https://assets.mixkit.co/active_storage/sfx/2869/2869-preview.mp3")
